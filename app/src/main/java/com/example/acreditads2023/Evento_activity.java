...
public class Evento_activity extends AppCompatActivity {
    ...
    private EditText edtAdministradorEvento;
    private EditText edtQREvento;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtAdministradorEvento = findViewById(R.id.edtAdministradorEvento);
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            e.setAdministradorEvento(edtAdministradorEvento.getText().toString());
